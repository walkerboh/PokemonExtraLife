...
namespace PokemonExtraLifeApi.EntityFramework.Initialization
{
    public static class TrainerInitialization
    {
        public static List<Trainer> Trainers = new List<Trainer>
        {
            ...
            {
                Id = 10,
                Name = "Guitarist Vincent",
                Gym = Gym.Electric
            },
            new Trainer
            {
                Id = 11,
                Name = "Bird Keeper Theo",
                Gym = Gym.Electric
            },
            new Trainer
            {
            ...
            {
                Id = 25,
                Name = "Gentlemen Alfred",
                Gym = Gym.Fire
            },
            new Trainer
            {
                Id = 26,
                Name = "Firebreather Ned",
                Gym = Gym.Fire
            },
            new Trainer
            {
